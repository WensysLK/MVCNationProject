...
<?php if (isset($_GET['update']) && $_GET['update'] == 'success'): ?>
    ...
    <script>
        // Redirect to remove the query string after displaying the message
...
<div class="content content-fixed bd-b">
        ...
        <div class="content">
            ...
            <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="available-contracts-tab" data-bs-toggle="tab"
                            ...
                            aria-controls="available-contracts" aria-selected="true">Total Leads</button>
                </li>
                <li class="nav-item" role="presentation">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="completed-tab" data-bs-toggle="tab" data-bs-target="#completed"
                            type="button" role="tab" aria-controls="completed" aria-selected="false">Future Purpose</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="deported-tab" data-bs-toggle="tab" data-bs-target="#deported"
                            type="button" role="tab" aria-controls="deported" aria-selected="false">Rejected</button>
                </li>
            </ul>
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="available-contracts" role="tabpanel"
                    ...
                    <?php
                    include dirname(__DIR__, 2) . "/views/leads/leads-parts/total-leads.php";
                   ?>
                ...
                <div class="tab-pane fade" id="pending" role="tabpanel" aria-labelledby="pending-tab">
                    ...
                    <?php
                    include dirname(__DIR__, 2) . "/views/leads/leads-parts/follow-up-leads.php";
                     ?>
                </div>
                <div class="tab-pane fade" id="processing" role="tabpanel" aria-labelledby="processing-tab">

                    <?php
                    include dirname(__DIR__, 2) . "/views/leads/leads-parts/registered-leads.php";
                     ?>
                </div>
    ...
    include dirname(__DIR__, 2) . "/views/leads/popups/add-lead-popup.php";
   ?>

    <script>
        $(document).ready(function() {
            fetchavailappCount();
            fetchIncompeleteCount();
        ...
        function fetchavailappCount() {
            ...
            $.ajax({
                ...
                url: BASE_URL + "application/get_available_app_total_count",
                method: 'GET',
                dataType: 'json',
                success: function($responseappcount) {
                    console.log($responseappcount);
        ...
        function fetchIncompeleteCount()
        {
            const BASE_URL = "<?php echo BASE_URL; ?>";
            $.ajax({
                url: BASE_URL + "application/get_incomplete_count", // The PHP script
                method: 'GET',
                dataType: 'json',
        ...
        function fetchAvailappprocessingCount() {
            const BASE_URL = "<?php echo BASE_URL; ?>";
            $.ajax({
                url: BASE_URL + "application/get_processing_count", // The PHP script
                method: 'GET',
                dataType: 'json',
        ...
        function fetchAvailappdepartureCount() {
            const BASE_URL = "<?php echo BASE_URL; ?>";
            $.ajax({
                url: BASE_URL + "application/get_departure_count", // The PHP script
                method: 'GET',
                dataType: 'json',
        ...
        function fetchAvailappDepotadCount() {
            const BASE_URL = "<?php echo BASE_URL; ?>";
            $.ajax({
                url: BASE_URL + "application/get_deported_count", // The PHP script
                method: 'GET',
                dataType: 'json',
                success: function($responseappdeparturecount) {
                    // Update the widget with the fetched count
                    $('#deportedcount').text($responseappdeparturecount.total);
                },
                error: function() {
