...
//include('../layouts/navigation-admin.php'); ?>
<div class="content content-fixed bd-b">
                    ...
                    <div class="media mg-t-20 mg-sm-t-0 mg-sm-l-15 mg-md-l-40">
                        ...
                        <div class="media-body">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <a href="<?php echo $baseUrl; ?>/medical/view_all_medicals.php" class="mg-l-10">View
                                    All</a>
                            </div>
                        </div>
                    </div>
                    <div class="media mg-t-20 mg-sm-t-0 mg-sm-l-15 mg-md-l-40">
                        ...
                        <div class="media-body">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <a href="<?php echo $baseUrl; ?>/Contracts/view_all_Contracts.php" class="mg-l-10">View
                                    All</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="media mg-t-20 mg-sm-t-0 mg-sm-l-15 mg-md-l-40">
                        ...
                        <div class="media-body">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <a href="<?php echo $baseUrl; ?>/muzaned/view_all_muzaned.php" class="mg-l-10">View
                                    All</a>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        function fetchMedicalCount() {
            const BASE_URL = "<?php echo BASE_URL; ?>";
            $.ajax({
                url: BASE_URL + "dashboard/get_medical_applications",
                method: 'GET',
                dataType: 'json',
                success: function (response) {
                    console.log(response);
                    // Update the widget with the fetched count
                    $('#currentmedical').text(response.total);
                },
                error: function () {
        ...
        function fetchContractCount() {
            const BASE_URL = "<?php echo BASE_URL; ?>";
            $.ajax({
                url: BASE_URL + "dashboard/get_contracts_applications",
                method: 'GET',
                dataType: 'json',
                success: function (response) {
                    console.log(response);
                    // Update the widget with the fetched count
                    $('#contractspro').text(response.total);
                },
                error: function () {
        ...
        function fetchEnjazCount() {
            const BASE_URL = "<?php echo BASE_URL; ?>";
            $.ajax({
                url: BASE_URL + "dashboard/get_enjaz_applications",
                method: 'GET',
                dataType: 'json',
                success: function (response) {
                    console.log(response);
                    // Update the widget with the fetched count
                    $('#enjazpro').text(response.total);
                },
                error: function () {
        ...
        function fetchMuzanedCount() {
            const BASE_URL = "<?php echo BASE_URL; ?>";
            $.ajax({
                url: BASE_URL + "dashboard/get_muzaned_applications",
                method: 'GET',
                dataType: 'json',
                success: function (response) {
                    console.log(response);
                    // Update the widget with the fetched count
                    $('#muzanedpro').text(response.total);
                },
                error: function () {
