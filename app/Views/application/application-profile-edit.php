...
<?php
include dirname(__DIR__, 2) . "/views/layouts/navigation-admin.php";
?>
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-md-flex align-items-center mb-3">
                ...
                <div class="ms-auto">
                    ...
                    <?php
                    include dirname(__DIR__, 2) . "/views/application/profile-parts/user-profile-buttons.php";
                    ?>
                </div>
            </div>
            <!--end breadcrumb-->
                ...
                <div class="card radius-15">
                    <div class="card-body">
                        ...
                        if ($row = mysqli_fetch_assoc($res)) {
                            ...
                            <p class="mb-0 text-muted"><?php // echo $serialNumber;
                                ?></p>
                            <p class="text-primary"><i class='bx bx-buildings'></i>
                                <span class="badge text-bg-success"><?php echo $clientstatus; ?></span>
                            </p>
                            <?php if ($client_register_date) { ?>
                                <p><strong>Register
                                        Date:</strong> <?php echo date('d M Y', strtotime($client_register_date)); ?>
                                </p> <!-- Registration Date -->
                            <?php } else { ?>
                                <p><strong>Register
                                        Date:</strong> <?php echo $client_register_date ?>
                                </p> <!-- Registration Date -->
                        <?php }  ?>
                                ...
                                <div class="col-12 col-lg-6">
                                    ...
                                    <?php if ($contractExists):
                                        ...
                                        <table class="table table-striped table-bordered mt-2" style="width:100%">
                                            ...
                                            <tr>
                                                <td>
                                                    <span class="badge text-bg-warning"><?php echo $contract['ContractStartus']; ?></span>
                                                </td>
                                    ...
                                    <?php else: ?>
                                        <div class="alert alert-warning" role="alert">No contract has been started for
                                            this applicant.
                                        </div>
                        ...
                        <div class="tab-content mt-3">
                            <div class="tab-pane fade show active" id="Experience">
                                <div class="card shadow-none border mb-0 radius-15">
                                    <?php
                                    include dirname(__DIR__, 2) . "/views/application/profile-edits/personal-information-tabs.php";
                                    ?>
                            ...
                            <div class="tab-pane fade" id="Biography">
                                <div class="card shadow-none border mb-0 radius-15">
                                    <div class="card-body">
                                        <?php
                                        include dirname(__DIR__, 2) . "/views/application/profile-edits/family-members-tabs.php";
                                        ?>
                            ...
                            <div class="tab-pane fade" id="Edit-Profile">
                                <div class="card shadow-none border mb-0 radius-15">
                                    <div class="card-body">
                                        <?php
                                        include dirname(__DIR__, 2) . "/views/application/profile-edits/qualifications-tabs.php";
                                        ?>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="education-tab">
                                <div class="card shadow-none border mb-0 radius-15">
                                    <div class="card-body">
                                        <?php
                                        include dirname(__DIR__, 2) . "/views/application/profile-edits/education-tabs.php";
                                        ?>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="Workexperiance">
                                <div class="card shadow-none border mb-0 radius-15">
                                    <div class="card-body">
                                        <?php
                                        include dirname(__DIR__, 2) . "/views/application/profile-edits/work-experiance-tabs.php";
                                        ?>
                            ...
                            <div class="tab-pane fade" id="documentations">
                                <div class="card shadow-none border mb-0 radius-15">
                                    <div class="card-body">
                                        <?php
                                        include dirname(__DIR__, 2) . "/views/application/profile-edits/documentation-tabs.php";
                                        ?>
...
<!-- End popup -->
<?php
include dirname(__DIR__, 2) . "/views/layouts/footer.php";
?>
